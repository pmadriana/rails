...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { Nombre: @alumno.Nombre, direccion: @alumno.direccion, fechadeMatriculacion: @alumno.fechadeMatriculacion, telefono: @alumno.telefono } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { Nombre: @alumno.Nombre, direccion: @alumno.direccion, fechadeMatriculacion: @alumno.fechadeMatriculacion, telefono: @alumno.telefono } }
